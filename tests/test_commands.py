...
from planet.models import Author, Feed, PostAuthorData
...
class CreateAuthorsForPostTest(TestCase):
    def test_creates_author_and_link(self):
        post = PostFactory()
        create_authors_for_post(post, [{"name": "Jane Doe"}])
