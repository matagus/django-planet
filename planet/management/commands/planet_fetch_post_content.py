...
class Command(BaseCommand):
    help = "Fetch and archive original content for posts where it is missing"

    def add_arguments(self, parser):
        parser.add_argument("--feed", type=int, help="Only process posts from this feed ID")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"Done: fetched content for {processed}/{total} posts.")
